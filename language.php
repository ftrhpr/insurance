...
function initialize_default_translations() {
    $default_translations = [
        ...
        'dashboard.completed_date' => 'Completed Date',
        'dashboard.review' => 'Review',
        'dashboard.no_completed_cases' => 'No completed cases yet',
        'dashboard.completed_cases_desc' => 'Completed service cases will appear here.',
