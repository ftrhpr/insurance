...
function initialize_default_translations() {
    $default_translations = [
        ...
        'case.confirm_appointment' => 'Manual Appointment Confirmation',
        'case.confirm_appointment_desc' => 'If the customer confirmed via phone or other means, manually mark this appointment as confirmed.',
        'case.confirm' => 'Confirm Appointment',
    ...
    $georgian_translations = [
        ...
        'case.vehicle_make' => 'მანქანის მარკა',
        'case.vehicle_model' => 'მანქანის მოდელი',
        'case.photos' => 'ფოტოები',
        ...
        'case.confirm_appointment' => 'ხელით დანიშვულების დადასტურება',
        'case.confirm_appointment_desc' => 'თუ კლიენტი დაამტკიცა ტელეფონით ან სხვა საშუალებით, ხელით მონიშნეთ ეს დანიშვულება როგორც დადასტურებული.',
        'case.confirm' => 'დანიშვულების დადასტურება',
