            ...
            <div class="flex justify-between h-18">
                <div class="flex items-center gap-8">
                    ...
                    <div class="hidden md:flex bg-slate-50/80 p-1.5 rounded-xl border border-slate-200/60 shadow-inner">
                        <a href="index.php" class="nav-inactive px-4 py-1.5 rounded-md text-sm transition-all flex items-center gap-2">
                            <i data-lucide="layout-dashboard" class="w-4 h-4"></i> Dashboard
                        </a>
                        <button class="nav-active px-4 py-1.5 rounded-md text-sm transition-all flex items-center gap-2">
                            <i data-lucide="database" class="w-4 h-4"></i> Vehicle DB
                        </button>
                        <a href="index.php#reviews" class="nav-inactive px-4 py-1.5 rounded-md text-sm transition-all flex items-center gap-2">
                            <i data-lucide="star" class="w-4 h-4"></i> Reviews
                        </a>
                        <a href="index.php#templates" class="nav-inactive px-4 py-1.5 rounded-md text-sm transition-all flex items-center gap-2">
                            <i data-lucide="message-square-dashed" class="w-4 h-4"></i> SMS Templates
                        </a>
                        <?php if ($current_user_role === 'admin'): ?>
                        <a href="index.php#users" class="nav-inactive px-4 py-1.5 rounded-md text-sm transition-all flex items-center gap-2">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-2 text-xs font-semibold bg-gradient-to-r from-emerald-50 to-teal-50 text-emerald-700 border border-emerald-200/60 px-3.5 py-2 rounded-xl shadow-sm">
                        <div class="relative">
