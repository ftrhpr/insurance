...
<head>
    ...
    <title>Calendar Test 3 - OTOMOTORS</title>
    ...
    <main class="ml-64 p-8">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-6 mb-6">
            ...
            <div class="mb-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                <p class="text-green-800">Query success: <?php echo $querySuccess ? 'YES' : 'NO'; ?></p>
                <p class="text-green-800">Cases in <?php echo $monthName; ?>: <?php echo $casesCount; ?></p>
                <p class="text-sm text-green-600">Date range: <?php echo $startDate; ?> to <?php echo $endDate; ?></p>
            </div>
