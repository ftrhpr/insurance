    ...
    <div class="flex min-h-screen">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div x-data="{ get open() { return this.$parent.openSections.includes('repair'); } }" class="bg-white rounded-2xl border border-slate-200/80">
                    <button @click="$parent.toggleSection('repair')" class="w-full flex items-center justify-between p-5">
                ...
                <div x-data="{ editingReview: false, get open() { return this.$parent.openSections.includes('feedback'); } }" class="bg-white rounded-2xl border border-slate-200/80">
