                    ...
                    <div x-show="isSectionOpen('details')" x-cloak x-transition class="px-5 pb-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5 border-t border-slate-200 pt-6">
                            ...
                            <div>
                                ...
                                <input id="input-nachrebi-qty" type="number" min="0" step="0.01" value="<?php echo htmlspecialchars($case['nachrebi_qty'] ?? 0); ?>" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/50 outline-none">
                            </div>
