                ...
                <div x-data="{ open: isSectionOpen('details') }" class="bg-white rounded-2xl border border-slate-200/80">
                    ...
                    <div x-show="open" x-cloak x-transition class="px-5 pb-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5 border-t border-slate-200 pt-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-1.5" x-text="currentCase.status === 'Scheduled' && currentCase.serviceDate ? 'Scheduled Date' : 'Service Date'"></label>
                                <input id="input-service-date" type="datetime-local" x-bind:value="currentCase.serviceDate ? currentCase.serviceDate.substring(0, 16) : ''" class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500/50 outline-none">
                            </div>
                            <div>
