...
set_error_handler(function($errno, $errstr, $errfile, $errline) {
    error_log("Reviews Page [$errno] $errstr in $errfile on line $errline");
    return true;
});

set_exception_handler(function($exception) {
    error_log('Reviews Exception: ' . $exception->getMessage());
...
requireLogin();
requireRole('manager'); // Reviews require manager or admin
$user = getCurrentUser();
?>
<!DOCTYPE html>
<html lang="en">
