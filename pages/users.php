...
set_error_handler(function($errno, $errstr, $errfile, $errline) {
    error_log("Users Page [$errno] $errstr in $errfile on line $errline");
    return true;
});

set_exception_handler(function($exception) {
    error_log('Users Exception: ' . $exception->getMessage());
...
requireLogin();
requireRole('admin'); // Users page is admin-only
$user = getCurrentUser();
?>
<!DOCTYPE html>
<html lang="en">
