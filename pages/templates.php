...
set_error_handler(function($errno, $errstr, $errfile, $errline) {
    error_log("Templates Page [$errno] $errstr in $errfile on line $errline");
    return true;
});

set_exception_handler(function($exception) {
    error_log('Templates Exception: ' . $exception->getMessage());
...
requireLogin();
requireRole('manager'); // Templates require manager or admin
$user = getCurrentUser();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="min-h-screen flex flex-col">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 flex-1">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-slate-900">SMS Templates</h1>
                    <p class="text-slate-600 mt-1">Customize automated SMS messages</p>
                </div>
            ...
            <div id="view-templates" class="space-y-6">
