    ...
    <div>
        ...
        <nav class="flex flex-col gap-1 mb-8">
            ...
            $nav_items = [
                ...
                'analytics' => ['icon' => 'bar-chart-3', 'label' => 'Analytics', 'url' => 'analytics.php'],
                ...
                'nachrebi_report' => ['icon' => 'package', 'label' => 'ნაჭრების რეპორტი', 'url' => 'nachrebi_report.php'],
                ...
                'offers' => ['icon' => 'ticket', 'label' => 'Offers', 'url' => 'offers.php'],
            ...
            if ($current_user_role === 'admin') {
                ...
                $nav_items['statuses'] = ['icon' => 'list-checks', 'label' => 'Statuses', 'url' => 'statuses.php'];
            }
            $icons = [
